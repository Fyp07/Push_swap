...
#    Updated: 2026/07/04 16:29:04 by fbarrada         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_stack.c operations.c main.c parsing.c validations.c sort_five.c ft_sqrt.c chunk.c $(PRINTF_SRCS) $(LIBFT_SRCS) $(LISTAS_SRCS)

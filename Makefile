...
#    Updated: 2026/07/07 16:00:44 by fbarrada         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_stack.c operations.c main.c parsing.c validations.c sort_five.c chunk.c algorithms.c $(PRINTF_SRCS) $(LIBFT_SRCS) $(LISTAS_SRCS)

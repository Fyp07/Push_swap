...
#    Updated: 2026/07/08 11:27:43 by fbarrada         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_stack.c operations.c main.c parsing.c validations.c sort_five.c chunk.c algorithms.c ranks.c $(PRINTF_SRCS) $(LIBFT_SRCS) $(LISTAS_SRCS)
